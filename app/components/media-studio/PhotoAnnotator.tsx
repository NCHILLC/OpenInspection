...
// No `MeasureCalibration` import: the Measure tool is removed in this fork
// (its first-use calibration dialog read as a broken tool mid-inspection), so
// the component does not exist here. See the fork log's deviations table.
