...
export function SpeedModeUndoToast({ pending, onDismiss, durationMs = 3000 }: SpeedModeUndoToastProps) {
    ...
    return (
        <div className="fixed left-1/2 -translate-x-1/2 bottom-20 z-50 px-4 py-2.5 bg-ih-bg-card border border-ih-border rounded-lg shadow-ih-popover flex items-center gap-3 text-[16px]">
