...
export function PublishModal({ open, progress, status, publishError, isSubmitting, onClose, onPublish, autoSign, onAutoSignToggle, isAmendment }: PublishModalProps) {
 ...
 <span className="block text-[15px] font-medium text-ih-fg-2 mb-1">
 ...
 <textarea
  ...
  className="w-full rounded-lg border border-ih-border bg-ih-bg-card px-2.5 py-1.5 text-[16px] text-ih-fg-1 placeholder:text-ih-fg-4 focus:border-ih-primary focus:ring-1 focus:ring-ih-primary"
 />
 </label>
 )}
