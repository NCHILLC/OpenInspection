...
describe('POST /api/invoices/request-payment — primary-client resolution (Task 9a)', () => {
    beforeEach(async () => {
        ...
        // Only inspection_people carries the primary client for this inspection.
        // (The seed used to also NULL out `clientName`/`clientEmail` to say so
        // explicitly; those columns have since been dropped from `inspections`
        // — see schema/inspection/core.ts — so there is nothing left to null.)
